...
public class AlmostExpItemAdapter extends FirestoreRecyclerAdapter<Item, AlmostExpItemAdapter.ItemHolder> {
    ...
    public AlmostExpItemAdapter(@NonNull final FirestoreRecyclerOptions<Item> options) {
        super(options);
    }
    ...
    public ItemHolder onCreateViewHolder(@NonNull final ViewGroup parent, final int viewType) {
        ...
        final View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.almost_exp_item, parent, false);
